...
**Example Project:**
See a real example generated by this extension: [my-mcp-server](https://github.com/jasonshen190/my-mcp-server/tree/main) — This repository demonstrates the structure and features you will get when using this extension.
